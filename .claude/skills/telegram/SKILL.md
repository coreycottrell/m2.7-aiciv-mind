...
description: Complete reference for Telegram bot operation, file transfers, voice messages, and troubleshooting. Use when sending messages to Corey, sharing files via Telegram, checking bot status, voice message handling, or any Telegram-related task.
---
